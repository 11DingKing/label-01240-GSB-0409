...
export const adminApi = {
  ...
  updateUserStatus: (id, status, reason) =>
    api.put(`/admin/users/${id}/status`, null, { params: { status, reason } }),
  getBlogs: (params) => api.get("/admin/blogs", { params }),
  updateBlogStatus: (id, status, reason) =>
    api.put(`/admin/blogs/${id}/status`, null, { params: { status, reason } }),
  ...
  getReviewHistory: (targetType, targetId) =>
    api.get(`/admin/review-logs/${targetType}/${targetId}`),
